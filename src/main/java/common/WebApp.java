...
public abstract class WebApp {
    ...
    public String getTextboxValueByID(By selector,  String textboxIDName) throws Exception
    {   WebElement el = this.safeElementWait(selector);
        return getElementAttribute(driver,"value", textboxIDName);
    }
